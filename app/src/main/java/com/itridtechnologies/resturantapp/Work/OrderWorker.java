...
public class OrderWorker extends Worker {
    ...
    public OrderWorker(@NonNull @NotNull Context context, @NonNull @NotNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        insertOrders(Constants.ORDER_ITEM);
        return Result.success();
    }

    private void insertOrders(OrdersItem order) {
        databaseRoom.mainDao().insertNewOrder(order);
    }
